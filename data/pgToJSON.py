...
# query = '''select s.family,s.genus,s.species
# 			from tgdr_data_availability t, species s, tgdr_study_sites tss, tgdr_samples ts
# 			where t.tgdr_association_data_id = tss.tgdr_association_data_id and tss.id = ts.tgdr_study_sites_id and ts.gps_latitude <> '' and t.species_id = s.species_id;'''
# rows = db_query(query).fetchall()
