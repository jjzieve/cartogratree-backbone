...
define([
  ...
  'bootstrap'
    ...
    type: "sample", //workaround to get mixin listenTo functions to get called with no arguments
    model: QueryModel,
    ...
    initColumns: function(){
      this.columns = [
        ...
        {id: "sequences", name: "Total sequences", field: "sequences",width: 135, sortable:true},
        {id: "genotypes", name: "Total genotypes", field: "genotypes",width: 130, sortable:true},
        {id: "phenotypes", name: "Total phenotypes", field: "phenotypes",width: 140, sortable:true},
